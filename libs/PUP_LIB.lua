...
- \cs(0, 0, 125)HP :\cr ${pet_current_hp|0}/${pet_max_hp|0} - \cs(0, 125, 0)MP :\cr ${pet_current_mp|0}/${pet_max_mp|0}
- \cs(255, 0, 0)TP :\cr ${pet_current_tp|0000|%04d}- \cs(255, 0, 0)WS Gear Lock Timer:\cr ${ws_gear_lock_timer|0}
]]
...
function setupTextWindow(pos_x, pos_y)
    ...
    default_settings.text.size = 9
    default_settings.text.font = 'Impact'
