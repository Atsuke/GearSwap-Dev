...
function initialize(text, settings)
	local properties = L{}
	properties:append('\\cs(255,135,0) Avatar: \\cr ${avatar}')
...
function set_hud_info()
	if pet.name then 
		element_color = Colors[pet.name]
		--smn_property.avatar = "\\cs(125,125,255)"..pet.name.."\\cr"
		smn_property.avatar = "".. element_color.. ""..pet.name.."\\cr"
	...
	for index,value in pairs(pacts) do
		...
		if pacts[index][pet.name] then 
			...
			tmp_sort[category][keybindtxt] = smn_property.pacts[category].."\n     ".. keybindtxt.. ": " .. element_color.. "".. pacts[index][pet.name]..'\\cr     ' 
		end
	end
	...
	if smn_property.pacts['Rage'] ~= '' then smn_property.pacts['Rage'] = "\\cs(255,135,0)Rage:\\cr"..smn_property.pacts['Rage'] end
	if smn_property.pacts['Ward'] ~= '' then smn_property.pacts['Ward'] = "\\cs(255,135,0)Ward:\\cr"..smn_property.pacts['Ward'] end
...
--    }
    ...
    pacts.misc1 = {['Ramuh']='Thunderspark',['Fenrir']='Moonlit Charge', ['Diabolos']='Ultimate Terror'}
	...
	pact_keys = {}
    pact_keys.cure = {['Ward']='Ctrl 9'}
    pact_keys.curaga = {['Ward']='Ctrl 0'}
    pact_keys.buffoffense = {['Ward']='Alt 1'}
    pact_keys.buffdefense = {['Ward']='Alt 0'}
    pact_keys.buffspecial = {['Ward']='Alt 7'}
    pact_keys.debuff1 = {['Ward']='Alt 6'}
    pact_keys.debuff2 = {['Ward']='Alt 9'}
    pact_keys.sleep = {['Ward']='Alt 8'}
    pact_keys.nuke2 = {['Rage']='Alt 2'}
    pact_keys.nuke4 = {['Rage']='Alt 4'}
    pact_keys.bp70 = {['Rage']='Alt 3'}
    pact_keys.bp75 = {['Rage']='Alt 5'}
    pact_keys.bprage1 = {['Rage']='Alt 2'}
    pact_keys.astralflow = {['Rage']=''}
    pact_keys.misc1 = {['Rage']='Ctrl 12'}
    --pact_keys.misc2 = {['Ward']=''}
...
function user_unload()
    send_command('lua u send_commands')
    --send_command('lua u pet_tp')
...
function job_get_spell_map(spell)
	...
	elseif enticersRagePacts:contains(spell.english) and spell.english ~= 'Impact' and pet_tp > 1400 then
...
--		end
	...
	-- if state.kclub.current == 'on' then 
