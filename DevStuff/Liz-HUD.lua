...
function buildHUD( useLightMode )
	if useLightMode then
		...
		hud_mode = [[${sections_color}Modes:]]..hud_idleMode..hud_meleeMode..hud_pet_mode..hud_nukingMode..hud_endofline
	end
	hud_options = [[${sections_color}Options:]]..hud_handleSkillchains..hud_lockWeapons..hud_lockMovespeed..hud_endofline
	hud_job = [[${sections_color}${player_job}:]]..hud_nukingElement..hud_indiCycle..hud_geoCycle..hud_entrustCycle..hud_mainWeapon..hud_subWeapon..hud_regenMode..hud_avatar..hud_rage..hud_ward..hud_makingSC..hud_Enspell..hud_endofline        
